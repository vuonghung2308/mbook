...
class TopNewFragment : Fragment(), Injectable {
    @Inject
    ...
    private val topNewAdapter: BookVerticalAdapter by lazy {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.topSale.adapter = topNewAdapter
        viewModel.topNew.observe(viewLifecycleOwner) {
            it.data ?: return@observe
            topNewAdapter.submitList(it.data)
